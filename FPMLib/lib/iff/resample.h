...
#ifndef _FF_IFF_RESAMPLE_H
#define _FF_IFF_RESAMPLE_H
...
struct _IFF_API  FixNNResampler
	:public Resampler
{
public:
...
struct  _IFF_API FixBL4Resampler
	:public Resampler
{
public:
	template<int _Shift,int _NC,typename _SrcT,typename _DestT>
...
struct _IFF_API  CubicResampler
	:public Resampler
{
...
struct  _IFF_API FixCubicResampler
	:public Resampler
{
